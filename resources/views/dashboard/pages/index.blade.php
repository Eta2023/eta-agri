                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                        <div class="card">
                              <div class="card-body">
                                ...
                                @isset($phylumCount1)
                                    <span class="fw-semibold d-block mb-1">Eubacteria Kingdom</span>
                                    <h3 class="card-title mb-2">{{$phylumCount1 ->count()}}</h3>
                                @else
                                    <p>Kingdom data not available.</p>
                                @endisset
                            </div>
                    ...
                    <div class="col-lg-6 col-md-12 col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                              ...
                              @isset($phylumCount2)
                                  <span class="fw-semibold d-block mb-1">Protista Kingdom</span>
                                  <h3 class="card-title mb-2">{{$phylumCount2->count()}}</h3>
                              @else
                                  <p>Kingdom data not available.</p>
                              @endisset
                          </div>
                    ...
                    <div class="col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                              ...
                              @isset($phylumCount3)
                                  <span class="fw-semibold d-block mb-1">Plantae Kingdom</span>
                                  <h3 class="card-title mb-2">{{$phylumCount3->count()}}</h3>
                              @else
                                  <p>Kingdom data not available.</p>
                              @endisset
                          </div>
                    ...
                    <div class="col-6 mb-4">
                        <div class="card">
                            <div class="card-body">
                              ...
                              @isset($phylumCount4)
                                  <span class="fw-semibold d-block mb-1">Fungi Kingdom</span>
                                  <h3 class="card-title mb-2">{{$phylumCount4->count()}}</h3>
                              @else
                                  <p>Kingdom data not available.</p>
                              @endisset
                          </div>
