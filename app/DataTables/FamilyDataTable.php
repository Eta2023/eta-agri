...
class FamilyDataTable extends DataTable
{
    ...
    {
        return $model->newQuery()->with('rank.classetas.phylums.kingdom');
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('nameEng'),
            Column::make('note'),
            Column::make('rank.classetas.phylums.nameAr')
            ->title('phylum name-Ar')
            ->searchable(true)
            ->orderable(true),
            Column::make('rank.classetas.phylums.nameEng')
            ->title('phylum name-Eng')
            ->searchable(true)
            ->orderable(true),
            Column::make('rank.classetas.phylums.kingdom.nameAr')
            ->title('kingdom name-Ar')
            ->searchable(true)
            ->orderable(true),
            Column::make('rank.classetas.phylums.kingdom.nameEng')
            ->title('kingdom name-Eng')
            ->searchable(true)
            ->orderable(true),
